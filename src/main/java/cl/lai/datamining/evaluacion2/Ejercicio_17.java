...
public class Ejercicio_17 extends App_loader_data_set{
	...
	public static Instances load_normal_data_set(String file)throws Exception{
		...
		inst.setValue(a1,792);
		inst.setValue(a2,810);
		inst.setValue(a3,793);
		inst.setValue(a4,594);
		inst.setValue(a5,615);
		...
		//KNN
		IBk knn = new IBk();
      	String[] options2 = new String[]{"-K","10"};//hacer que 5 sea el knn
